...
2. из значений табельных и нормативных часов вычитаются дополнительные и получаются показатели 1к и 1н соответственно
...
Аналитику доступен инструмент при помощи которого он собирает накопители с дополнительными часами в единый файл. Сводный накопитель разделен на две таблицы: 
- дополнительные часы без 1к1н
- показатели 1к1н
...
Для решения задачи используем инструмент Power Query от Microsoft. С его помощью объеденияем данные из проектов в единую таблицу и обогащаем их информацией из справочников.
...
- файл схема
- для имени таблицы с дополнительными часами используется одно из следующих наименований: "доп_часы", "дополнительные_часы", "_доп_часы_шаблон"
...
- что-то не подтянулось из схемы
...
## Структура инструмента по листам Excel
